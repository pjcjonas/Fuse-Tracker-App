...
: Factory
{
readonly Func<object> _create;public UxFactory(Func<object> create, string matchCase, bool isDefault)
...
: base(new [] {new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("127.0.0.1"), 12124), new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("172.18.8.1"), 12124), new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("192.168.56.1"), 12124), new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("192.168.0.2"), 12124)}, "C:\\Users\\pjcjo\\Documents\\Fuse\\SharpSpring Tracker\\SharpSpring Tracker.unoproj", new string[] { })
{
